...
const initialValues = { //mock data
    ...
    coursePreferences: {
        "CSC 225": {
            willingness: 1, difficulty: 2
        },
        "CSC 226": {
            willingness: 0, difficulty: 0
        },
        "ECE 260": {
            willingness: 2, difficulty: 2
        },
        "ECE 310": {
            willingness: 1, difficulty: 0
        },
        "SENG 265": {
            willingness: 0, difficulty: 1
        },
        "SENG 310": {
            willingness: 1, difficulty: 2
        },
